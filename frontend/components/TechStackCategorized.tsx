        ...
        },
        {
          ...
          logo: (
            <svg viewBox="0 0 256 256" className="w-10 h-10">
              <path
                fill="#0080FF"
                d="M128 256v-50.469c56.926 0 83.626-46.525 66.635-95.316-5.607-16.107-18.018-28.518-34.125-34.125C111.719 58.18 65.194 84.88 65.194 141.806H14.725C14.725 58.596 93.195 1.027 178.142 28.427c27.36 8.827 48.906 30.373 57.733 57.733C263.275 171.107 205.706 256 128 256z"
              />
